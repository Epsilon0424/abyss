...
MARBLE_BERRY_FIXED_UNIQUE = "꿈열차에 실린 기억"
...
def marble_berry_allowed_uniques() -> List[str]:
    return [MARBLE_BERRY_FIXED_UNIQUE, "밀키웨이맛 쿠키의 기억", "새벽을 여는 달빛술사 쿠키의 기억"]
...
def optimize_marble_berry_cycle(
    ...
    potentials = [dict(potential_override)] if potential_override is not None else marble_berry_allowed_potentials()
                ...
                for pot in potentials:
                    ...
                    try:
                        ...
                        def cycle_for(
                            ...
                            return marble_berry_cycle_damage_fast(stats, party, artifact_name)
