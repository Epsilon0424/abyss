...
# 상수
# =====================================================
CHARLOTTE_FIXED_UNIQUE   = "멜랑크림 쿠키의 순수한 기억"
...
# 회복 규칙: 이벤트 횟수 기반
CHAR_HEAL_MAIN_RATIO = 0.56     # 궁극기 즉시 체력 회복
CHAR_HEAL_KNOT_RATIO = 0.112    # 궁극기 매듭 체력 회복
CHAR_SOUL_HEAL_RATIO = 0.10     # 승급 영혼꿰기 체력 회복
