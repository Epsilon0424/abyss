...
`;
    ...
    function cookieSimRecognizeUniqueShard(shape, visualFeature, artFeature, spatialFeature, cardFeature) {
        ...
        // First compare the complete normalized in-game card thumbnail. This path uses
        // the same fixed 6% inner crop on both the uploaded screenshot and stored
        // samples, so equipped tags can no longer move the foreground crop and erase
        // the distinctive staggered Road Nightmare layout.
