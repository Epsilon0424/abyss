...
def potential_value_key(kind: str, stat_key: str) -> str:
    return f"potential_value__{kind}__{stat_key}"
...
def reset_party_defaults_for_kind(kind: str) -> None:
    """Reset role party slots and optional dealer slots for the selected main cookie."""
