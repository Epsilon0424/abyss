...
_UNIQUE_REFERENCE_DIR = _PROJECT_ROOT / "img" / "유니크조각_시즌4"
_UNIQUE_INGAME_REFERENCE_DIR = _UNIQUE_REFERENCE_DIR / "인게임"
_UNIQUE_SEASON1_REFERENCE_DIR = _PROJECT_ROOT / "img" / "유니크조각_시즌1"
_UNIQUE_SEASON2_REFERENCE_DIR = _PROJECT_ROOT / "img" / "유니크조각_시즌2"
_UNIQUE_SEASON3_REFERENCE_DIR = _PROJECT_ROOT / "img" / "유니크조각_시즌3"
_UNIQUE_REFERENCE_METADATA_PATH = _SHARD_STATIC_DIR / "unique_reference_metadata_season4.json"
_UNIQUE_SEASON1_REFERENCE_METADATA_PATH = _SHARD_STATIC_DIR / "unique_reference_metadata_season1.json"
_UNIQUE_SEASON2_REFERENCE_METADATA_PATH = _SHARD_STATIC_DIR / "unique_reference_metadata_season2.json"
_UNIQUE_SEASON3_REFERENCE_METADATA_PATH = _SHARD_STATIC_DIR / "unique_reference_metadata_season3.json"
...
_UNIQUE_SEASON1_REFERENCE_SHAPES = {
    "나비스의 기억": [[0, 1], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2], [3, 1]],
    "데스파라거스의 기억": [[0, 1], [0, 2], [0, 3], [0, 4], [1, 0], [1, 1], [1, 2], [1, 3]],
    "로스베이컨맛 쿠키의 기억": [[0, 0], [1, 0], [1, 1], [2, 0], [2, 1], [3, 0], [3, 1], [4, 1]],
    "슈가스타의 기억": [[0, 0], [0, 1], [1, 0], [1, 1], [2, 0], [2, 1], [3, 0], [3, 1]],
    "아르고의 기억": [[0, 1], [0, 2], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2], [2, 3]],
    "용감한 쿠키의 기억": [[0, 0], [0, 1], [0, 2], [0, 3], [1, 0], [1, 1], [1, 2], [1, 3]],
    "윈드파라거스 쿠키의 기억": [[0, 0], [0, 1], [0, 2], [0, 3], [1, 1], [1, 2], [2, 1], [2, 2]],
    "정화된 에메랄딘의 기억": [[0, 1], [0, 2], [1, 0], [1, 1], [1, 2], [1, 3], [2, 1], [2, 2]],
}

_UNIQUE_SEASON2_REFERENCE_SHAPES = {
    "다크초코 쿠키의 기억": [[0, 1], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2], [3, 1]],
    "연금술사맛 쿠키의 기억": [[0, 1], [0, 2], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2], [2, 3]],
    "선데맛 쿠키의 기억": [[0, 0], [0, 1], [0, 2], [0, 3], [1, 1], [1, 2], [2, 1], [2, 2]],
    "오래된 샬롯맛 쿠키의 기억": [[0, 0], [0, 1], [0, 2], [0, 3], [1, 0], [1, 1], [1, 2], [1, 3]],
    "블랙베리맛 쿠키의 기억": [[0, 0], [1, 0], [1, 1], [2, 0], [2, 1], [3, 0], [3, 1], [4, 1]],
    "웨어울프맛 쿠키의 기억": [[0, 0], [0, 1], [0, 2], [0, 3], [1, 0], [1, 1], [1, 2], [1, 3]],
    "샬롯맛 쿠키의 기억": [[0, 1], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2], [3, 1]],
    "버터밀크맛 쿠키의 기억": [[0, 1], [0, 2], [0, 3], [0, 4], [1, 0], [1, 1], [1, 2], [1, 3]],
    "콜라비맛 쿠키의 기억": [[0, 0], [0, 1], [1, 0], [1, 1], [2, 0], [2, 1], [3, 0], [3, 1]],
}

_UNIQUE_SEASON3_REFERENCE_SHAPES = {
    "피닉스페퍼 쿠키의 기억": [[0, 1], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2], [3, 1]],
    "폭주한 룽샤맛 쿠키의 기억": [[0, 1], [0, 2], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2], [2, 3]],
    "꺼지지 않는 봉화의 기억": [[0, 1], [0, 2], [1, 0], [1, 1], [1, 2], [1, 3], [2, 1], [2, 2]],
    "마라맛 쿠키의 기억": [[0, 1], [0, 2], [0, 3], [0, 4], [1, 0], [1, 1], [1, 2], [1, 3]],
    "룽샤맛 쿠키의 기억": [[0, 0], [0, 1], [0, 2], [0, 3], [1, 1], [1, 2], [2, 1], [2, 2]],
    "크러쉬드페퍼맛 쿠키의 기억": [[0, 0], [0, 1], [1, 0], [1, 1], [2, 0], [2, 1], [3, 0], [3, 1]],
    "체리맛 쿠키의 기억": [[0, 0], [1, 0], [1, 1], [2, 0], [2, 1], [3, 0], [3, 1], [4, 1]],
    "불야성의 밤의 기억": [[0, 0], [0, 1], [0, 2], [0, 3], [1, 0], [1, 1], [1, 2], [1, 3]],
    "칠리맛 쿠키의 기억": [[0, 0], [0, 1], [0, 2], [0, 3], [1, 0], [1, 1], [1, 2], [1, 3]],
}
...
def _normalize_unique_season(season_mode: str | None = None) -> str:
    season = str(season_mode or "season4").strip().lower()
    return season if season in {"season1", "season2", "season3", "season4"} else "season4"

def _unique_shapes_for_season(season_mode: str | None = None) -> dict[str, list[list[int]]]:
    season = _normalize_unique_season(season_mode)
    if season == "season1":
        return _UNIQUE_SEASON1_REFERENCE_SHAPES
    if season == "season2":
        return _UNIQUE_SEASON2_REFERENCE_SHAPES
    if season == "season3":
        return _UNIQUE_SEASON3_REFERENCE_SHAPES
    return _UNIQUE_REFERENCE_SHAPES

def _build_unique_reference_metadata(season_mode: str = "season4") -> dict[str, dict]:
    """시즌별 유니크 조각 참조 메타데이터 생성"""
    season = _normalize_unique_season(season_mode)
    shapes = _unique_shapes_for_season(season)
    metadata: dict[str, dict] = {}
    for unique_name, shape in shapes.items():
        if season in {"season1", "season2", "season3"}:
            reference_dir = {
                "season1": _UNIQUE_SEASON1_REFERENCE_DIR,
                "season2": _UNIQUE_SEASON2_REFERENCE_DIR,
                "season3": _UNIQUE_SEASON3_REFERENCE_DIR,
            }[season]
            image_path = reference_dir / f"{unique_name}.png"
            if not image_path.exists():
                image_path = reference_dir / f"{unique_name}.jpg"
            art_sample = _unique_ingame_art_feature(image_path)
            spatial_sample = _unique_ingame_spatial_feature(image_path)
            card_sample = _unique_ingame_card_feature(image_path)
            encoded = base64.b64encode(image_path.read_bytes()).decode("ascii") if image_path.exists() else ""
            metadata[unique_name] = {
                "shapeSignature": _shape_signature(shape),
                "feature": _unique_reference_cell_features(image_path, shape),
                "artFeature": art_sample,
                "artSamples": [art_sample] if art_sample else [],
                "spatialSamples": [spatial_sample] if spatial_sample else [],
                "cardSamples": [card_sample] if card_sample else [],
                "spatialFeature": spatial_sample,
                "sampleImageUris": [f"data:image/png;base64,{encoded}"] if encoded else [],
...
@lru_cache(maxsize=4)
def _unique_reference_metadata(season_mode: str = "season4") -> dict[str, dict]:
    """시즌별 유니크 조각 참조 메타데이터 로드"""
    season = _normalize_unique_season(season_mode)
    shapes = _unique_shapes_for_season(season)
    if season == "season1":
        metadata_path = _UNIQUE_SEASON1_REFERENCE_METADATA_PATH
    elif season == "season2":
        metadata_path = _UNIQUE_SEASON2_REFERENCE_METADATA_PATH
    elif season == "season3":
        metadata_path = _UNIQUE_SEASON3_REFERENCE_METADATA_PATH
    else:
        metadata_path = _UNIQUE_REFERENCE_METADATA_PATH
    if metadata_path.exists():
        try:
            loaded = json.loads(metadata_path.read_text(encoding="utf-8"))
            expected_names = set(shapes)
            ...
            pass
    return _build_unique_reference_metadata(season)

def _unique_priority_for_cookie(cookie_name: str, season_mode: str = "season4") -> list[str]:
    """시즌별 쿠키 유니크 조각 우선순위"""
    ...
    if season == "season1":
        if role == "dps":
            ...
            return [first, "슈가스타의 기억", "용감한 쿠키의 기억"]
        if role == "strike":
            return ["나비스의 기억", "윈드파라거스 쿠키의 기억"]
        if role == "support":
            if name in {"달빛술사 쿠키", "달빛술사맛 쿠키"}:
                return ["데스파라거스의 기억", "정화된 에메랄딘의 기억"]
            return ["정화된 에메랄딘의 기억", "데스파라거스의 기억"]
        return []

    if season == "season2":
        if role == "dps":
            first = "샬롯맛 쿠키의 기억" if attack_type in {"shoot", "magic"} else "다크초코 쿠키의 기억"
            return [first, "웨어울프맛 쿠키의 기억", "오래된 샬롯맛 쿠키의 기억"]
        if role == "strike":
            return ["선데맛 쿠키의 기억", "연금술사맛 쿠키의 기억"]
        if role == "support":
            if name == "샬롯맛 쿠키":
    ...
    if season == "season3":
        if role == "dps":
            ...
            return [first, "꺼지지 않는 봉화의 기억", "칠리맛 쿠키의 기억"]
        if role == "strike":
            return ["룽샤맛 쿠키의 기억", "마라맛 쿠키의 기억"]
        if role == "support":
            if name in {"달빛술사 쿠키", "달빛술사맛 쿠키"}:
                return ["불야성의 밤의 기억", "크러쉬드페퍼맛 쿠키의 기억", "체리맛 쿠키의 기억"]
            return ["크러쉬드페퍼맛 쿠키의 기억", "체리맛 쿠키의 기억", "불야성의 밤의 기억"]
        return []
...
def _inline_assets(base_html: str, priority_sets: list[str], target_counts: dict[str, int], target_text: str, english: bool = False, theme_mode: str = 'system', glass_stat_items: list | None = None, cookie_name: str = '', season_mode: str = 'season4') -> str:
    ...
    window.COOKIE_SIM_UNIQUE_REFERENCE_META = {json.dumps(_unique_reference_metadata(season_mode), ensure_ascii=False)};
    window.COOKIE_SIM_UNIQUE_PRIORITY = {json.dumps(_unique_priority_for_cookie(cookie_name, season_mode), ensure_ascii=False)};
    window.COOKIE_SIM_SEASON = {json.dumps(_normalize_unique_season(season_mode))};
...
def _load_solver_html(target_text: str = "", english: bool | None = None, theme_mode: str | None = None, glass_stat_items: list | None = None, cookie_name: str = '', season_mode: str = 'season4') -> str:
    ...
    return _inline_assets(base_html, priority_sets, target_counts, target_text, english=english, theme_mode=theme_mode, glass_stat_items=glass_stat_items, cookie_name=cookie_name, season_mode=season_mode)

def render_shard_placement_tab(target_text: str = "", english: bool | None = None, theme_mode: str | None = None, glass_shards: dict | None = None, cookie_name: str = '', season_mode: str = 'season4') -> None:
    """설탕유리조각 배치 탭 렌더링"""
    ...
    if glass_shards:
        try:
            ...
            glass_stat_items = []
    components.html(
        _load_solver_html(target_text, english=english, theme_mode=theme_mode, glass_stat_items=glass_stat_items, cookie_name=cookie_name, season_mode=season_mode),
        height=865,
        scrolling=True,
    )
