...
폭주한 룽샤맛 쿠키의 기억 : Runaway Mala Longxia Cookie's Memory
꺼지지 않는 봉화의 기억 : Ever-burning Beacon Memory
마라맛 쿠키의 기억 : Mala Sauce Cookie's Memory
룽샤맛 쿠키의 기억 : Mala Longxia Cookie's Memory
크러쉬드페퍼맛 쿠키의 기억 : Crushed Pepper Cookie's Memory
체리맛 쿠키의 기억 : Cherry Cookie's Memory
불야성의 밤의 기억 : Sleepless Streets Memory
칠리맛 쿠키의 기억 : Chilli Pepper Cookie's Memory
...
유성우의 향연 : 달빛술사는 속성 내성 감소 10% 적용
Falling Stars : Moonlight applies Elemental RES Reduction 10%

이슬 + 크러쉬드페퍼 : 방어력 관통 12% → 8% 적용
Dew + Crushed Pepper : Def Penetration 12% → 8% applied
...
_EXTRA_ENGLISH = {
    ...
    "유성우의 향연 : 달빛술사는 속성 내성 감소 10% 적용": "Falling Stars: Moonlight applies Elemental RES Reduction 10%",
    "달빛술사는 속성 내성 감소 10% 적용": "Moonlight applies Elemental RES Reduction 10%",
    "이슬 + 크러쉬드페퍼 : 방어력 관통 12% → 8% 적용": "Dew + Crushed Pepper: Def Penetration 12% → 8% applied",
    ...
    "방어력 관통 12% → 8% 적용": "Def Penetration 12% → 8% applied",
